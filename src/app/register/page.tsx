            ...
            if (process.env.NEXT_PUBLIC_API_URL) {
                const response: Response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/users/register`, {
                    ...
                    body: JSON.stringify({
                        ...
                        mobile: "+30" + stringUtils.trimValue(String(formData.get("mobile"))),
                        firstName: stringUtils.trimValue(String(formData.get("first-name"))),
                        lastName: stringUtils.trimValue(String(formData.get("last-name"))),
